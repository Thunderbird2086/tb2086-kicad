module.exports = {
  ...
  body: p => {
    const standard_opening = `(
         footprint "TB2086_KEYSWITCH:SW_MX_HS_1.75u"
        (version 20241229)
        (generator "pcbnew")
    ...
    const front_fabrication = `
        (property "Value" "SW_MX_HS_1.75u" (at 0 -8 ${0 + p.rot}) (layer "F.Fab") (hide yes)  (effects (font (size 1 1) (thickness 0.15))))
    ...
    `
    const user_drawing = `
        (fp_line (start -16.66875 -9.525) (end 16.66875 -9.525) (stroke (width 0.12) (type solid)) (layer "Dwgs.User") )
        (fp_line (start -16.66875 9.525) (end -16.66875 -9.525) (stroke (width 0.12) (type solid)) (layer "Dwgs.User") )
        (fp_line (start 16.66875 -9.525) (end 16.66875 9.525) (stroke (width 0.12) (type solid)) (layer "Dwgs.User") )
        (fp_line (start 16.66875 9.525) (end -16.66875 9.525) (stroke (width 0.12) (type solid)) (layer "Dwgs.User") )
    `
    ...
    const model = `
        ...
        (model "\${KIPRJMOD}/tb2086-kicad/packages3D/Keycaps/DSA_1.75u.step" (offset (xyz 9.525 0 12)) (scale (xyz 1 1 1)) (rotate (xyz -90 -0 -0)))
