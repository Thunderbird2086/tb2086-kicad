module.exports = {
  ...
  body: p => {
    ...
    const back_silkscreen = `
        (fp_text user "\${REFERENCE}" (at 0 -0.5 ${0 + p.rot}) (unlocked yes) (layer "B.SilkS") (hide yes) (uuid "014c5fd7-e342-428f-ab14-a5b2425f308c") (effects (font (size 1 1) (thickness 0.15)) (justify mirror)))
    `
