module.exports = {
  ...
  body: p => {
    ...
    const standard_opening = `(
        ...
        (property "Reference" "${p.ref}" (at 0 -1.68 ${0 + p.rot}) (layer "${p.side}.SilkS") ${p.ref_hide} (effects (font (size 1 1) (thickness 0.15))))
        (attr smd)
    ...
    `
    const model = `
        (model "\${KIPRJMOD}/tb2086-kicad/packages3D/C_0805_2012Metric.step" (offset (xyz 0 0 0)) (scale (xyz 1 1 1)) (rotate (xyz 0 0 0)))
    `
