module.exports = {
  ...
  body: p => {
    ...
    const user_drawing = `
        ...
        (fp_line (start 9 -8.5) (end 9 8.5) (stroke (width 0.12) (type solid)) (layer "Dwgs.User") )
        (fp_line (start 9 8.5) (end -9 8.5) (stroke (width 0.12) (type solid)) (layer "Dwgs.User") )
        (fp_text user "18x17 spacing" (at 0 -7.6 ${180 + p.rot}) (layer "Dwgs.User")  (effects (font (size 1 1) (thickness 0.15))))
    `
    const user_comments = `
        ...
        (fp_text user "19.05 spacing" (at 0 -8.7 ${180 + p.rot}) (layer "Cmts.User")  (effects (font (size 1 1) (thickness 0.15))))
    `
    const user_eco1 = `
    `
    const user_eco2 = `
