module.exports = {
  ...
  body: p => {
    let fp_name = 'TB2086_MISC:Nice!View_'
    if (p.reversible) {
        fp_name += 'rev'
    } else {
        fp_name += 'with_window'
    ...
    const front_fabrication = `
        (property "Value" "${fp_name}" (at 0.02 -13.4 ${0 + p.rot}) (layer "F.Fab") (hide yes)  (effects (font (size 0.8128 0.8128) (thickness 0.15))))
