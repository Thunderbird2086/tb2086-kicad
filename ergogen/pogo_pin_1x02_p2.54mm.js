module.exports = {
  ...
  body: p => {
    const standard_opening = `(
         footprint "TB2086_MISC:Pogopin_1x02_P2.54mm"
        (version 20240108)
        (generator "pcbnew")
    ...
    const front_fabrication = `
        (property "Value" "Pogopin_1x02_P2.54mm" (at 0 2 ${0 + p.rot}) (unlocked yes) (layer "F.Fab")  (effects (font (size 1 1) (thickness 0.15))))
    ...
    `
    const pads = `
        (pad "1" thru_hole circle (at -1.27 0 ${p.rot}) (size 2.1 2.1) (drill 0.9) (layers "*.Cu" "*.Mask") (remove_unused_layers no)  ${p.P1})
        (pad "2" thru_hole circle (at 1.27 0 ${p.rot}) (size 2.1 2.1) (drill 0.9) (layers "*.Cu" "*.Mask") (remove_unused_layers no)  ${p.P2})
    `
