module.exports = {
  ...
  body: p => {
    const standard_opening = `(
         footprint "TB2086_MISC:Tag_Pogopin_1x03_P2.54mm"
        (version 20240108)
        (generator "pcbnew")
        (generator_version "8.0")
        (layer "F.Cu")
        (property "Reference" "${p.ref}" (at 0 -1.27 ${0 + p.rot}) (unlocked yes) (layer "${p.side}.SilkS") ${p.ref_hide} (effects (font (size 1 1) (thickness 0.1))))
        (attr smd)
    ...
    `
    const front_pads = `
        (pad "1" smd circle (at -2.54 0 ${p.rot}) (size 0.9 0.9) (layers "F.Cu" "F.Paste" "F.Mask")  ${p.P1})
        (pad "2" smd circle (at 0 0 ${p.rot}) (size 0.9 0.9) (layers "F.Cu" "F.Paste" "F.Mask")  ${p.P2})
        (pad "3" smd circle (at 2.54 0 ${p.rot}) (size 0.9 0.9) (layers "F.Cu" "F.Paste" "F.Mask")  ${p.P3})
    `
    const front_fabrication = `
        (property "Value" "Tag_Pogopin_1x03_P2.54mm" (at 0 1.5 ${0 + p.rot}) (unlocked yes) (layer "F.Fab")  (effects (font (size 1 1) (thickness 0.15))))
