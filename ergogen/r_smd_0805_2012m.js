module.exports = {
  params: {
    ...
    show_3d: false,
    P2: undefined, // change to undefined as needed
    P1: undefined, // change to undefined as needed
  },
  body: p => {
    const standard_opening = `(
         footprint "R_0805_2012Metric_Pad1.20x1.40mm_HandSolder_rev"
        (version 20240108)
        (generator "pcbnew")
    ...
    const front_fabrication = `
        (property "Value" "R_0805_2012Metric_Pad1.20x1.40mm_HandSolder_rev" (at 0 1.65 ${0 + p.rot}) (layer "F.Fab") (uuid "6264eead-45d6-41c5-8b9f-173ccc59d3cf") (effects (font (size 1 1) (thickness 0.15))))
        ...
        (fp_text user "\${REFERENCE}" (at 0 0 ${0 + p.rot}) (layer "F.Fab") (uuid "2a12e1fe-6583-480f-b520-69f04005c491") (effects (font (size 0.5 0.5) (thickness 0.08))))
    `
